...
-   **Weak impact on the migration plan** of the individuals ([**MMS**]{style="color: red;"})
    ...
    -   Only [**6% of MMS**]{style="color: red;"} respondant reported that the Covid-19 outbreak **affected their plan** regarding their stay in Switzerland.
...
**H: We expect a bigger effect of COVID-19 at the beggining of migrants life course.**

-   To compare the effect of COVID-19 over the life course we need **data from the pandemic period in every life cycle step**.
...
-   [Anchoring = Attach. to country of origin - Attach. to Switzerland]{style="color: red;"}
-   Only on migrants returning to the country of origin
-   Only on migrants with family on the country of origin

------------------------------------------------------------------------

## Limits (2)

-   Attachment to country of origin missing in [**TAS**]{style="color: blue;"}

-   Share willing to go to the country of origin: [**52% MMS**]{style="color: red;"} and [**73% TAS**]{style="color: blue;"}

    -   Up to half of the data

-   **Colinerarity** between haveing a **family member** in the country of origin and the **level of attachment** in the country of origin
